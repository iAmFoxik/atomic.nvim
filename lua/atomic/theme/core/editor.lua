...
function M.setup(configColors, configStyle)
    ...
    return {
        ...
        FloatBorder            = { fg = colors.title },                                              -- Float Title
        ...
        Whitespace             = { fg = colors.bg2 },                                                -- 'nbsp', 'space', 'tab' and 'trail' in 'listchars'
        ...
        DiagnosticFloatingWarn = { fg = colors.git.changed, bg = colors.diff.change },               -- Mini.files
    }
end
